		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RoutinNavigation",
									"targetURL": "#zbtpday6exercise3gundaya-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exercise3gundaya-display": {
								"semanticObject": "zbtpday6exercise3gundaya",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exercise3gundaya",
									"url": sap.ui.require.toUrl("zbtp/day6exercise3gundaya")
								}
							}
						}
					}
